/*
 * @(#)AlternativeEvaluator.java		2008/02/02
 *
...
import net.lurgee.ninemensmorris.NineMensMorrisBoardLinks;
import net.lurgee.ninemensmorris.NineMensMorrisPlayer;
import net.lurgee.sgf.AbstractBoard;
import net.lurgee.sgf.Evaluator;

/**
 * Another nine men's morris evaluator. Used by a {@link net.lurgee.sgf.AbstractSinglePassSearcher searcher} to score board states. This
 * evaluator is based on the standard evaluator {@link NineMensMorrisEvaluator}, but is included here to be tweaked for
